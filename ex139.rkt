...
(check-error (checked-sum (cons -1 '())) "Error: list-of-amounts expected")
(check-expect (checked-sum (cons 1 (cons 1 '()))) 2)
(check-error (checked-sum (cons -1 (cons 1 '()))) "Error: list-of-amounts expected")
(check-error (checked-sum (cons 1 (cons -1 '()))) "Error: list-of-amounts expected")
(define (checked-sum lon)
  (cond
    [(pos? lon) (sum lon)]
    [else (error "Error: list-of-amounts expected")]))
